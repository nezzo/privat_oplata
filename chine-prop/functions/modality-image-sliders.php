...
function modality_unslider_slider() {
	...
	<div class="clear"></div>
	<div class="banner">
		<div class="big_text">STOP-LOSSOV.NET</div>
			<div class="small_text">это первый мультиброкерский проп-проект</div>
...
function news_unslider_slider() {
	...
	<div class="clear"></div>
	<div class="banner">
		<div class="big_text">НОВОСТИ</div>
...
function servis_unslider_slider() {
	global $post;
	$modality_theme_options = modality_get_options( 'modality_theme_options' );
	$slider_cat = $modality_theme_options['image_slider_cat'];
	$num_of_slides = $modality_theme_options['slider_num'];
	...
	<div class="clear"></div>
	<div class="banner">
		<div class="big_text">Наши услуги</div>
